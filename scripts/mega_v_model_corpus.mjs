...
const gate=JSON.parse(await readFile('docs/handoffs/mega-v/model-runtime.json','utf8'));
...
const rows=[],out='docs/handoffs/mega-v/model-corpus.json',identity=x=>JSON.stringify([x.subject,x.field,x.value]),pct=f=>100*rows.filter(f).length/rows.length;
