...
try{
  ...
  await writeFile('docs/handoffs/mega-iii-iv/postgres-proof.json',JSON.stringify({lane:'CONTROLLED_SESSION_TEMPORARY_TABLES',passed:checks.length,failed:0,checks,extraction:{text:doc.text,candidates:doc.candidates,source:doc.source},operationalFixtureWrites:0},null,2));console.log(JSON.stringify({passed:checks.length,checks}));
