...
ROOT=Path('/workspace');OUT=Path('/output/mega-vii');OUT.mkdir(parents=True,exist_ok=True)
...
with sync_playwright() as p:
 ...
 for cold in range(int(os.environ.get('SAMPLE_OFFSET','0')),int(os.environ.get('SAMPLE_OFFSET','0'))+int(os.environ.get('COLD_SAMPLES','3'))):
