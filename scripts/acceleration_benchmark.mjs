...
try{
 ...
 await writeFile('docs/handoffs/acceleration/'+(process.env.PHASE??'before')+'-knowledge-performance.json',JSON.stringify(output,null,2));console.log(JSON.stringify(output,null,2));
