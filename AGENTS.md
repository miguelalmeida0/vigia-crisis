# AGENTS.md — Frontend Product Design & Engineering Operating Contract
...
2. The nearest scoped `AGENTS.override.md` or nested `AGENTS.md`.
3. Approved design references, design-system files, and locked screenshots.
4. This root contract.
5. Activated task-specific skills under `.agents/skills/`.
...
| Task | Required skill |
|---|---|
| New page, component, visual system, or product surface | `.agents/skills/product-ui-art-direction/SKILL.md` |
| Existing UI redesign or visual recovery | `.agents/skills/redesign-audit/SKILL.md` |
| Implementing from screenshots, Figma exports, or locked mockups | `.agents/skills/mockup-to-code/SKILL.md` |
| Responsive, mobile, keyboard, zoom, focus, or accessibility work | `.agents/skills/responsive-accessibility/SKILL.md` |
| Dashboard, table, chart, graph, map, telemetry, or dense product UI | `.agents/skills/data-rich-ux/SKILL.md` |
| Final visual verification or any claim that UI is “done” | `.agents/skills/visual-qa/SKILL.md` |
| Full-file or exhaustive deliverable | `.agents/skills/full-output/SKILL.md` |
...
Required evidence is defined in `.agents/skills/mockup-to-code/SKILL.md` and `.agents/skills/visual-qa/SKILL.md`.
