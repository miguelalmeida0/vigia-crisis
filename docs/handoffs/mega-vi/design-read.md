...
Direction: the existing light operational system in docs/product/DESIGN.md. Design variance 1/10, motion intensity 1/10, visual density 7/10. Reuse existing navy text, restrained red selection, blue informational controls, hairlines, typography and drawer primitives. No new routes or equal-weight card grid.
