...
export function projectCrisisAutopilot(input = {}, { portfolioOnly = false } = {}) {
  ...
  // The portfolio consumes these same computed sections. It never consumes
  // incident-detail bindings, temporal sections, council, or their hashes.
  if (portfolioOnly) return { autopilot: { doingNow: active }, decisionCompression: decisionIntelligence.decisionCompression, sentinel, strategicIntelligence };
