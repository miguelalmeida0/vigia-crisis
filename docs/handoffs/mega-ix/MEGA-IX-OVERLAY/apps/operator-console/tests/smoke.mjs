...
assert.deepEqual(linkedStyles,[...activeStyles,...['approved/tokens.css','approved/shell.css','approved/components.css','approved/routes.css','approved/responsive.css','approved/runtime-compat.css','approved/integration.css','approved/signals.css','approved/field.css','approved/hierarchy.css','approved/situation.css','approved/mission-command.css']],'retained legacy and approved CSS imports must have deterministic ownership');
...
console.log('Smoke verification passed: six approved primary routes and internal history and canonical endpoint clients are present.');
