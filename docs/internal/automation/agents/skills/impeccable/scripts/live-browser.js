...
void main() {
  ...
  //
  // Design System Panel - visualizes the project's docs/internal/automation/impeccable/design.json sidecar
  //
  ...
  let designState = {
    ...
    sidecar: null,          // docs/internal/automation/impeccable/design.json v2 payload (extensions + components + narrative)
    hasMd: false,
    hasSidecar: false,
  ...
  function renderStaleHint() {
    ...
    box.innerHTML = `
      ...
      <span class="stale-text"><strong>docs/product/DESIGN.md is newer than docs/internal/automation/impeccable/design.json.</strong> Run <code>${IMPECCABLE_COMMAND} document</code> to refresh the sidecar.</span>
    `;
    return box;
  }
  ...
  function renderParsedMdCta() {
    ...
    box.innerHTML = `<strong>Basic view</strong>This panel reads the tokens in your <code>docs/product/DESIGN.md</code> frontmatter. Running <code>${IMPECCABLE_COMMAND} document</code> also generates a <code>docs/internal/automation/impeccable/design.json</code> sidecar with your project's actual component snippets (button, input, nav) and tonal ramps, rendered live below the tokens.`;
    return box;
  }
  ...
  function designEmptyMessage() {
    if (designState.hasMd && !designState.hasSidecar) {
      return 'docs/product/DESIGN.md found, no structured tokens to display. Run ' + IMPECCABLE_COMMAND + ' document to generate the docs/internal/automation/impeccable/design.json sidecar.';
    }
  ...
  function cssSafe(v) {
    ...
    // docs/internal/automation/impeccable/design.json values rendered into inline style strings.
