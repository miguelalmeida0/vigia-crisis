# AGENTS.override.md — VIGIA Product UI & Geospatial Contract

> Place this file at the VIGIA repository root as `AGENTS.override.md` or merge its rules into the nearest scoped agent contract.
