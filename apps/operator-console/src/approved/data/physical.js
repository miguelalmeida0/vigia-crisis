...
const definitions={temperature:['Temperature','°C'],wind:['Wind','km/h'],gust:['Wind gusts','km/h'],humidity:['Humidity','%'],rain:['Rain','mm'],windDirection:['Wind from',''],fireDanger:['Official fire danger',''],thermalTime:['Latest thermal detection',''],thermalDistance:['Nearest thermal detection','km'],thermalProduct:['Satellite / product',''],frp:['Fire radiative power','MW'],thermal30:['Detections · 30m',''],thermal60:['Detections · 1h',''],thermal180:['Detections · 3h',''],independentFamilies:['Independent physical families',''],pm25:['PM2.5','µg/m³'],pm10:['PM10','µg/m³'],ozone:['Ozone','µg/m³'],aqCategory:['Air quality',''],aqDistance:['Distance to AQ station','km'],smoke:['Modelled smoke',''],officialStatus:['Official incident status',''],warnings:['Active official warnings',''],nearestIncident:['Nearest known incident record','km'],windToward:['Wind toward location','']};
export function displayMetric(input={},now=Date.now()) {
  ...
  return {...input,available:hasValue,display:hasValue?(input.id==='thermalTime'?timeLabel(input.value):shown):missingLabel,missingText,
