...
assert.deepEqual(linkedStyles,[...activeStyleNames,...['approved/tokens.css','approved/shell.css','approved/components.css','approved/routes.css','approved/responsive.css','approved/runtime-compat.css','approved/integration.css','approved/signals.css','approved/field.css','approved/hierarchy.css','approved/situation.css']],'approved CSS follows retained legacy styles; runtime enables exactly one presentation');
