...
async function handleRequest(req,res) {
  ...
  if(url.pathname==='/__operator/logout'){
    ...
    admissionSessions.delete(cookie(req,admissionCookieName));securityHeaders(res);res.writeHead(204,{'cache-control':'no-store','set-cookie':`${admissionCookieName}=; Path=/; Max-Age=0; HttpOnly; SameSite=Strict`});res.end();return;
  }
